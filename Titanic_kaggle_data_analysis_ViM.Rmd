---
title: "R Notebook for Titanic Kaggle data analysis"
output:
html_document:
...
# Read data and creating feature engineering
...
combined_data_new$AgeGroup<- as.factor(combined_data_new$AgeGroup)
...
perf_gbm_test <- h2o.performance(gbm, newdata = test)
...
fwrite(pred[,c("PassengerId","Survived"),with=FALSE],"prediction_submission_03_ViM.csv",sep = ",")
```
